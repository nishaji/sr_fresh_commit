...
public class AddCertificate extends BaseActivity implements DatePickerDialog.OnDateSetListener {
    ...
    @BindView(R.id.certificate_status)EditText cert_status;
    ...
    private void setuptoolbar() {
        ...
        add_cert_tool.setTitle(" Add Certificate");
        ...
        add_cert_tool.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AddCertificate.this, CertificateActivity.class);
    ...
    void addCertificate(){
        if(authority.getText().toString().length()==0||cert_name.getText().toString().length()==0||cert_status.getText().toString().length()==0||certificate_type.getText().toString().length()==0||rank.getText().toString().length()==0||du_text.getText().toString().length()==0){
            ...
            databaseHelper.setCertificate(Certificate.builder()
                    .setAuthority(authority.getText().toString())
                    .setName(cert_name.getText().toString()).setStatus(cert_status.getText().toString())
                    .setType(certificate_type.getText().toString()).setRank(rank.getText().toString())
                    .setCertdate(du_text.getText().toString())
                    .setDate(date.toString()).setPostflag("0").setPutflag("0").build());
