...
public class AddProject extends BaseActivity {
    ...
    private void setuptoolbar() {
        ...
        add_pro_tool.setTitle(" Add Project");
        ...
        add_pro_tool.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AddProject.this, ViewActivity.class);
    ...
    void onButtonClick(){
        if(project_name.getText().toString().length()==0||responsibility.getText().toString().length()==0||role.getText().toString().length()==0||du_text.getText().toString().length()==0){
