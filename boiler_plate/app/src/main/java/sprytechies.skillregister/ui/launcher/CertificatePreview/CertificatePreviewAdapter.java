...
public class CertificatePreviewAdapter extends RecyclerView.Adapter<CertificatePreviewAdapter.CertificateViewHolder> {
    ...
    public void onBindViewHolder(CertificatePreviewAdapter.CertificateViewHolder holder,final int position) {
        ...
        holder.certificate_status.setText(certificateInsert.certificate().status());
                ...
                .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialogBox, int id) {
                        databaseHelper.edit_certificate(Certificate.builder()
                                ...
                                .setCertdate(duration.getText().toString())
                                .setName(cert_name.getText().toString())
                                .setRank(rank.getText().toString())
    ...
    class CertificateViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.view_certificate_status) TextView certificate_status;
