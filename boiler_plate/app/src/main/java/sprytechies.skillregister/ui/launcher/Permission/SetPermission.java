...
public class SetPermission extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences settings = SetPermission.this.getSharedPreferences(SignActivity.PREFS_NAME, 0);
    ...
    private void setuptoolbar() {
        ...
        toolbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SetPermission.this, ViewActivity.class);
   ...
   void save_permission(){
            ...
            edubit=edu.getText().toString();
            expbit=exp.getText().toString();
            certbit=cert.getText().toString();
            contactbit=contact.getText().toString();
            awardbit=award.getText().toString();
            projectbit=project.getText().toString();
            publicationbit=publication.getText().toString();
            volunteerbit=volunteer.getText().toString();
