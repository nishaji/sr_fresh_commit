...
public class EducationPreviewAdapter extends RecyclerView.Adapter<EducationPreviewAdapter.EducationViewHolder> {
    ...
    private void edit_education() {
        ...
        // location.setText(education.get(0).education().loc().name());
                ...
                .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialogBox, int id) {
                        ...
                        databaseHelper.edit_education
                                (Education.builder()
                                        .setCgpi(cgpi.getText().toString())
                                        .setCgpitype(cgpi_type.getText().toString())
                                        .setCourse(course.getText().toString())
                                        .setEdutype(education_type.getText().toString())
                                        .setFrom(from)
                                        .setUpto(to)
                                        .setLocation(new Location(location.getText().toString(),location_type.getText().toString()))
                                        .setSchool(schoolname.getText().toString())
                                        .setSchooltype(school_type.getText().toString())
