...
public class SkillSuggessionAdapter extends ArrayAdapter<String> {
    private List<String> suggestions;

    public SkillSuggessionAdapter(Activity context, String nameFilter) {
    ...
    public Filter getFilter() {
        Filter myFilter = new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (constraint != null) {
                    List<SkillSugession> new_suggestions = jp.getSkill(constraint.toString());
                    suggestions.clear();
