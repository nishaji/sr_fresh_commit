...
public class ExperienceActivity extends BaseActivity implements ExperienceMvp {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        experiencePresenter.attachView(this);
        experiencePresenter.loadExperience();
        setuptoolbar();
    }
    private void setuptoolbar() {
        ...
        toolbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ExperienceActivity.this, ViewActivity.class);
    ...
    public void showExperiences(List<ExperienceInsert> experienceInserts) {
        experineceAdapter.setExperience(experienceInserts);
        experineceAdapter.notifyDataSetChanged();
    }

    @Override
    public void showExperienceEmpty() {
        DialogFactory.createGenericErrorDialog(this, getString(R.string.error_loading_experience))
                .show();
    }
