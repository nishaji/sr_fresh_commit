...
public class PullService  extends Service {
    ...
    private void get_profile_data() {
                ...
                if (response.code() == 200) {
                    ...
                    for (int i = 0; i < awards.size(); i++) {
                        databaseHelper.setAwards(Award.builder()
                                ...
                                .setCreateflag("1").setUpdateflag("1").setPostflag("0").setPutflag("1").build());
                    }
                }
            }
                ...
                if (response.code() == 200) {
                    ...
                    for (int i = 0; i < cert.size(); i++) {
                        databaseHelper.setCertificate(Certificate.builder()
                                ...
                                .setCreateflag("1").setUpdateflag("1").setPostflag("0").setPutflag("1")
                                .setCertdate(cert.get(i).getCertdate().toString()).setName(cert.get(i).getName())
                                .setRank(cert.get(i).getRank()).setStatus(cert.get(i).getStatus()).setType(cert.get(i).getType()).build());
                    }
                }
            }
                ...
                if (response.code() == 200) {
                    ...
                    for (int i = 0; i < pros.size(); i++) {
                        databaseHelper.setProject(Project.builder()
                                .setDate(date.toString()).setCreateflag("1").setUpdateflag("1").setPostflag("0").setPutflag("1")
        ...
        Call<List<GetProfile>> call6 = service.get_profile(id,access_token);
            ...
            public void onResponse(Call<List<GetProfile>> call, Response<List<GetProfile>> response) {
                ...
                if (response.code() == 200) {
                    ...
                    for (int i = 0; i < awards.size(); i++) {
                        ...
                        databaseHelper.saveProfile(SaveProfile.builder()
                                .setType(awards.get(i).getType())
                                .setMeta(meta)
                                .setskill(skills)
                                .setLan(languages)
                                .build());
