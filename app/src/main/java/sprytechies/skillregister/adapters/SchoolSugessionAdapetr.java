...
public class SchoolSugessionAdapetr extends ArrayAdapter<String> {

    protected static final String TAG = "SchoolSugessionAdapetr";
    private List<String> suggestions;

    public SchoolSugessionAdapetr(Activity context, String nameFilter) {
