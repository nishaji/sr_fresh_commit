...
import skillregister.co.ribot.skllregister.sprytechies.skillregister.data.DataManager;
import skillregister.co.ribot.skllregister.sprytechies.skillregister.data.local.DatabaseHelper;
import skillregister.co.ribot.skllregister.sprytechies.skillregister.data.local.PreferencesHelper;
import skillregister.co.ribot.skllregister.sprytechies.skillregister.data.model.Ribot;
import skillregister.co.ribot.skllregister.sprytechies.skillregister.data.remote.RibotsService;
